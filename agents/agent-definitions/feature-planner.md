...
lies in breaking down complex features into manageable implementation plans while
ensuring proper research and agent consultation.
...
**For Simple Features:**
Single checklist with integrated testing

**For Complex Features:**
Break into logical steps, each with:
...
## Problem Statement
Missing commonly used git aliases in shell configuration, reducing developer productivity.
...
- **Aliases**: gs (git status), gaa (git add -A), gcm (git commit -m), gp (git push)
...
4. **Specify Technical Details**: Include all file locations, naming conventions,
   and dependencies
...
direction, proper research integration, and systematic implementation approaches.